...
public class EditProductActivity extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
        ...
        btnProfile.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent in = new Intent(getApplicationContext(), ProductProfile.class);
                in.putExtra(TAG_PID, pid);
                in.putExtra(TAG_PROPICURL,propicurl);
                startActivity(in);
				...
				public void run() {
					...
					try {
						...
						if (success == 1) {
                            ...
                            txtpicUrl = (EditText) findViewById(R.id.inputpicUrl);
							// display product data in EditText
							txtName.setText(product.getString(TAG_NAME));
							txtPrice.setText(product.getString(TAG_PRICE));
							txtDesc.setText(product.getString(TAG_DESCRIPTION));
                            txtpicUrl.setText(product.getString(TAG_PROPICURL));
						}else{
	...
	class SaveProductDetails extends AsyncTask<String, String, String> {
		...
		protected String doInBackground(String... args) {
            ...
            String propicurl = txtpicUrl.getText().toString();
			// Building Parameters
			List<NameValuePair> params = new ArrayList<NameValuePair>();
            ...
            params.add(new BasicNameValuePair(TAG_PROPICURL, propicurl));
